# Road Rage Detection Pipeline - Web Application

A modern web interface for the AI-powered Road Rage Detection Pipeline. Upload dashcam videos and receive real-time analysis with threat assessment, safety guidance, and comprehensive incident reports.
